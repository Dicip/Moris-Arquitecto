    ...
    >
      ...
      >
        ...
        >
          ...
          >
            DAVID MORIS · Consultas y Proyectos
          </p>
        </div>
      </div>
      ...
      >
        <div style={{ maxWidth: '520px', width: '100%', marginLeft: 'auto', marginRight: 'auto' }}>
          ...
          >
             Cuéntanos sobre tu proyecto y construyamos algo juntos.
          </h3>
          ...
          {submitted ? (
            ...
            >
              Gracias — me comunicaré contigo dentro de 48 horas para discutir tu proyecto en detalle.
            </div>
          ) : (
            <form
            ...
            >
              ...
              <Row>
                ...
                />
                <Field label="Presupuesto estimado" type="text" name="budget" placeholder="ej. $500K – $1M" value={formData.budget} onChange={handleChange} />
              </Row>
              <Row>
                <Field label="Plazo deseado" type="text" name="timeline" placeholder="ej. 12–18 meses" value={formData.timeline} onChange={handleChange} />
                <Field label="Nombre completo" type="text" name="name" placeholder="Juan Pérez" value={formData.name} onChange={handleChange} />
              </Row>
              <Field label="Correo electrónico" type="email" name="email" placeholder="tu@dominio.com" value={formData.email} onChange={handleChange} />
              <TextareaField
                label="Cuéntanos sobre tu proyecto"
                name="message"
                placeholder="Describe tu visión, terreno y cualquier requisito específico…"
